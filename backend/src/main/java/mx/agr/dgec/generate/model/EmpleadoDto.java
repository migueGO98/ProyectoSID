...
public class EmpleadoDto {
  ...
  private JsonNullable<String> correoElectronico = JsonNullable.<String>undefined();

  private String telefono;

  private JsonNullable<String> extensionTelefono = JsonNullable.<String>undefined();
  ...
  public EmpleadoDto(String idEmpleado, Boolean activo, LocalDate fechaIngreso, String correoElectronico, String telefono, String extensionTelefono, String idTipoPlaza, String idPuesto, String idDireccion, String idSubdireccion) {
    ...
    this.correoElectronico = JsonNullable.of(correoElectronico);
    this.telefono = telefono;
    this.extensionTelefono = JsonNullable.of(extensionTelefono);
  ...
  */
  ...
  public JsonNullable<String> getCorreoElectronico() {
    return correoElectronico;
  }

  public void setCorreoElectronico(JsonNullable<String> correoElectronico) {
  ...
  */
  ...
  public JsonNullable<String> getExtensionTelefono() {
    return extensionTelefono;
  }

  public void setExtensionTelefono(JsonNullable<String> extensionTelefono) {
